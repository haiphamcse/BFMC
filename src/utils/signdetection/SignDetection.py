...
class SignDetectionProcess(WorkerProcess):
    ...
    def _init_threads(self):
        ...
        if self._blocker.is_set():
            return
        detectTh = Thread(name='SignDetectionThread',target = self._send_thread, args= (self.inPs[0], ))
        detectTh.daemon = True
        self.threads.append(detectTh)
